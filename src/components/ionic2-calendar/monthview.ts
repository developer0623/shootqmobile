...
@Component({
    ...
    template: `
        <div>
            <ion-item class="calendar-month-view-header">
                <button ion-button icon-only item-left (click)="prevSlide()">
                    <ion-icon name="ios-arrow-back"></ion-icon>
                </button>
                {{viewTitle}}
                <button ion-button icon-only item-right (click)="nextSlide()">
    ...
    styles: [`
        ...
        .monthview-selected {
          border: 2px solid #13a3ff !important;
