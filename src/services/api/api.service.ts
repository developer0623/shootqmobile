...
export class ApiService {
  ...
  // http://dev-api.shootq.io/api/v1/person/contact/
  // public apiUrl: string = 'http://sqapi.sqngtestdev.shootq.io/api/v1';
  // public oAuthUrl: string = 'http://sqapi.sqngtestdev.shootq.io';
  ...
  public setHeaders(id?: number) {
    let oAuthTokenRaw = localStorage.getItem('OAuthInfo');
